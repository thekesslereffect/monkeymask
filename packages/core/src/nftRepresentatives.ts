...
//   metadata_representative = an IPFS sha2-256 CID digest encoded as a pubkey
//
...
// bananojs (encoding needs blake2b for the checksum, which is why this lives
// here and not in @monkeymask/wallet-standard's pure decode-side codecs).
