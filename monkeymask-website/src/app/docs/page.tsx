  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-[1500px] px-4 py-12 md:py-20 space-y-30">
          ...
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex items-center gap-3">
              ...
              <Button variant="default" size="lg" asChild>
                <Link href={`https://github.com/thekesslereffect/monkeymask/tree/main/monkeymask-nextjs-starter`} target='blank'>
        ...
        {/* Quickstart */}
        <section id="quickstart" className="max-w-4xl mx-auto flex flex-col gap-8">
